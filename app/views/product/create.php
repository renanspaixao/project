                    ...
                    <form id="formProduct" method="post">
                        <div class="row g-3">
                            <div class="col-md-7">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Digite o Nome do Produto" required maxlength="255">
                            </div>
                            <div class="col-md-5">
                                <label for="price" class="form-label asterisk">Preço</label>
                                <input type="text" class="form-control" id="price" name="price" placeholder="Digite o Preço do Produto" required maxlength="11">
                            </div>
                        </div>
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm mb-3" id="add-variation">+ Adicionar Variação</button>

                        <hr class="mb-4">
                        <div class="d-flex justify-content-center mt-4">
                            <button type="submit" class="btn btn-success me-2" title="Cadastrar Produto">Cadastrar</button>
                            <button type="reset" class="btn btn-warning me-2" title="Limpar os Campos">Limpar</button>
                            <a href="/product" class="btn btn-info" title="Voltar á Listagem">Voltar</a>
                        </div>
                    </form>
                </div>
            </div>
